...
// @Router /deposit/handle [post]
func AcceptRejectDepositRequest(w http.ResponseWriter, r *http.Request, db *sql.DB) {
	...
	err = deposit.Deposit(db, clientUserID, amount, currency)
	if err != nil {
